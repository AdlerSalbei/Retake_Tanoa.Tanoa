...
private ["_i","_i2","_unit","_dir","_nPos","_grp"];
params ["_handle", "_style", "_syncedUnit", "_range", "_fleeDir"];
	...
	_grp = LV_ACS_activeGroups select _i;
	{
		...
		switch(_style)do{
			...
			case (1):{
				...
				[_unit,_nPos] spawn LV_fnc_deleteOnDestination;
			};
			case (2):{
				[_unit, _range] spawn LV_fnc_killAfterDelay;
			};
		};
